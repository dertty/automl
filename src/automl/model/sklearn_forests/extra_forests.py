...
class ExtraTreesRegression(BaseModel):
    def __init__(
        self,
        n_estimators=100,
        ...
        self.name = "ExtraTreesRegression"
    ...
    def fit(self, X: FeaturesType, y: TargetType, categorical_features=[]):
        ...
        for i, (train_idx, test_idx) in enumerate(cv):
            ...
            fold_model = EXRegSklearn(**self.params)
    ...
    def objective(self, trial, X, y, metric):
        ...
        model = EXRegSklearn(**trial_params, **not_tuned_params)
...
class ExtraTreesClassification(BaseModel):
    def __init__(
        self,
        n_estimators=100,
        criterion="gini",
        ...
        self.name = "ExtraTreesClassification"
